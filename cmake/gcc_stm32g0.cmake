...
SET(STM32_CHIP_TYPES 071xx CACHE INTERNAL "stm32f0 chip types")
SET(STM32_CODES "071.[8B]")

MACRO(STM32_GET_CHIP_TYPE CHIP CHIP_TYPE)
    STRING(REGEX REPLACE "^[sS][tT][mM]32[gG]((03[018].[468C])|(04[28].[46])|(05[18].[468])|(07[0128].[68B])|(09[18].[BC])).*$" "\\1" STM32_CODE ${CHIP})
    SET(INDEX 0)
...
MACRO(STM32_GET_CHIP_PARAMETERS CHIP FLASH_SIZE RAM_SIZE CCRAM_SIZE)
    STRING(REGEX REPLACE "^[sS][tT][mM]32[gG](0[3478][01]).[8B].*$" "\\1" STM32_CODE ${CHIP})
    STRING(REGEX REPLACE "^[sS][tT][mM]32[gG]0[3478][01].([8B]).*$" "\\1" STM32_SIZE_CODE ${CHIP})
    ...
    message(STATUS "Chip Type: " ${TYPE})
    IF(${TYPE} STREQUAL 071xx)
        SET(RAM "32K")
    ENDIF()
...
FUNCTION(STM32_SET_CHIP_DEFINITIONS TARGET CHIP_TYPE)
    ...
    IF(TARGET_DEFS)
        SET(TARGET_DEFS "STM32G0;STM32G${CHIP_TYPE};${TARGET_DEFS}")
    ELSE()
        SET(TARGET_DEFS "STM32G0;STM32G${CHIP_TYPE}")
    ENDIF()
