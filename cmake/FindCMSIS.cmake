...
ELSEIF(STM32_FAMILY STREQUAL "G0")
    IF(NOT STM32Cube_DIR)
        SET(STM32Cube_DIR "/opt/STM32Cube_FW_G0_V1.3.0")
        MESSAGE(STATUS "No STM32Cube_DIR specified, using default: " ${STM32Cube_DIR})
    ENDIF()

    STRING(REGEX REPLACE "[B8]" "x" STM32_DEVICE_NUM ${STM32_CHIP_TYPE})
    #message(STATUS "DevNum: " ${STM32_DEVICE_NUM})
    SET(CMSIS_STARTUP_SOURCE startup_stm32g${STM32_DEVICE_NUM}.s)
